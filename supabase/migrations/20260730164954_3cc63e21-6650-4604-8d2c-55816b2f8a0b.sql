...
-- R28: merge idea cards into a real section --------------------------------
...
BEGIN
  ...
  -- Build the lyric lines from the chosen cards, in the order they were picked.
  SELECT
  ...
  -- Keep the provenance: the cards now belong to this section.
  UPDATE public.canvas_cards
     SET section_id_ref = _section_id
   WHERE FALSE; -- no such column; provenance is carried by section_label below
