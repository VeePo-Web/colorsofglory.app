 ...
 * filing it into a song happens later, in the review step.
 */
const CaptureShell = ({
  phase,
  durationMs,
  ...
  return (
    <>
      ...
      <div
        role="dialog"
        aria-modal="true"
        aria-label={isDenied ? "Microphone permission required" : "Capturing idea"}
        style={{
          position: "fixed",
          bottom: 0,
          left: 0,
        ...
        {isDenied ? (
          ...
          >
            ...
            <p style={{ fontFamily: "var(--font-body)", fontSize: 14, color: "#666", lineHeight: 1.5, margin: 0 }}>
              Colors of Glory can't hear your idea without microphone permission. Tap below to open Settings.
            </p>
            {error && (
