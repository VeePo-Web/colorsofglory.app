# COLORS OF GLORY — PROJECT AGENTS.md
...
All global personas from `~/.Codex/AGENTS.md` remain active. The following are specifically relevant to this project:
...
*This AGENTS.md overrides all fly4me context. This is a fresh build.*
